...
class GPT(nn.Module):
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, matrix_lr=0.02,
        ...
        chunk_interface_lr = embedding_lr * dmodel_lr_scale * 0.5
        chunk_interface_scale_lr = scalar_lr * 0.05
        param_groups = [
            ...
            dict(kind='adamw', params=chunk_interface_params, lr=chunk_interface_lr, betas=adam_betas, eps=1e-10, weight_decay=0.0),
            dict(kind='adamw', params=chunk_interface_scale_params, lr=chunk_interface_scale_lr, betas=(0.96, 0.95), eps=1e-10, weight_decay=0.0),
