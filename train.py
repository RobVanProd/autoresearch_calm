...
class GPT(nn.Module):
    def __init__(self, config):
        ...
        self.chunk_encoder_refine = nn.Linear(config.n_embd, config.n_embd, bias=True)
    ...
    def init_weights(self):
        ...
        torch.nn.init.eye_(self.chunk_encoder_refine.weight)
        torch.nn.init.zeros_(self.chunk_encoder_refine.bias)
    ...
    def num_scaling_params(self):
        ...
        chunk_encoder_refine = sum(p.numel() for p in self.chunk_encoder_refine.parameters())
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, matrix_lr=0.02,
        ...
        chunk_encoder_refine_params = list(self.chunk_encoder_refine.parameters())
    ...
    def forward(self, idx, targets=None, reduction='mean'):
        ...
        x = x + self.chunk_encoder_refine_scale * (self.chunk_encoder_refine(x) - x)
