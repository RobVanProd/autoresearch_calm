...
class GPT(nn.Module):
    def __init__(self, config):
        ...
        self.chunk_decode_hidden_dim = 240
        ...
        self.chunk_decode_hidden = nn.Linear(config.n_embd, self.chunk_decode_hidden_dim, bias=True)
        self.chunk_decode_proj = nn.Linear(self.chunk_decode_hidden_dim, self.chunk_size * config.n_embd, bias=False)
    ...
    def num_scaling_params(self):
        ...
        total = wte + chunk_gate + chunk_gate_hidden + chunk_gate_resid + chunk_resid + chunk_pre_adapter + chunk_pre_backbone + chunk_decode_offsets + chunk_decode_hidden + chunk_decode_proj + chunk_pre_norm + chunk_interface + chunk_interface_scale + token_shortcut_head + shortcut_scale + value_embeds + lm_head + transformer_matrices + scalars
        return {
            'wte': wte, 'chunk_gate': chunk_gate, 'chunk_gate_hidden': chunk_gate_hidden, 'chunk_gate_resid': chunk_gate_resid, 'chunk_resid': chunk_resid, 'chunk_pre_adapter': chunk_pre_adapter, 'chunk_pre_backbone': chunk_pre_backbone, 'chunk_decode_offsets': chunk_decode_offsets, 'chunk_decode_hidden': chunk_decode_hidden, 'chunk_decode_proj': chunk_decode_proj, 'chunk_pre_norm': chunk_pre_norm, 'chunk_interface': chunk_interface, 'chunk_interface_scale': chunk_interface_scale, 'token_shortcut_head': token_shortcut_head, 'shortcut_scale': shortcut_scale,
